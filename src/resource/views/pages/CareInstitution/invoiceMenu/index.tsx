            ...
            <Table responsive bordered hover className="invoice-table">
              ...
              {!called || loading ? (
                ...
                <tr>
                  ...
                  <td className="date-col">{invoiceData.invoiceDate ? moment(invoiceData.invoiceDate).format(defaultDateFormat) : '-'}</td>                              <td className="caregiver-col">
                                {invoiceData.caregiver ?
                                  ...
                                  >
                                    {[invoiceData.caregiver.firstName, invoiceData.caregiver.lastName].join(' ')}
                                  </div> : null}
