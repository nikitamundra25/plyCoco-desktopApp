...
import { languageTranslation, dateDiffernceValidator, dateValidator, dateValidatorNorm } from '../../../../../helpers';
import {
  ...
  any> = (
    ...
    const workingHourDateValidator = (name: string) => {
      ...
      if (name === "workingHoursFromDate") {
        ...
        validate = dateDiffernceValidator(breakFromDate, current, breakToDate, name)
        console.log("dateFromdateFrom", validate);
        if (!validate) {
        ...
        <div className='form-section'>
          ...
          >
            ...
            <Row>
              ...
              {selctedAvailability &&
                selctedAvailability.status === 'confirmed' && new Date(activeDateCaregiver[0]) <= new Date() ? (
                  <>
                    <Col lg={'12'}>
                      <FormGroup>
                        <Row>
