...
const CarinstituionListView: FunctionComponent<IAppointmentCareInstitutionList &
  any> = (props: IAppointmentCareInstitutionList & any) => {
    ...
    const [openCareInstitutionBulkEmail, setopenCareInstitutionBulkEmail] = useState<boolean>(
      false
    );
        ...
        >
          ...
          >
            <Nav vertical>
              ...
              <NavItem>
                <NavLink disabled={selectedCellsCareinstitution ? selectedCellsCareinstitution.length === 0 : true} onClick={() => handleCareGiverBulkEmail('day', true)}>
                  <img src={offer_sent} className='mr-2' alt='' />
                  <span>
                    Select available caregivers, offer them appointments and set
              ...
              <NavItem>
                <NavLink disabled={selectedCellsCareinstitution ? selectedCellsCareinstitution.length === 0 : true} onClick={() => handleCareGiverBulkEmail('division', false)}>
                  <img src={offer_sent} className='mr-2' alt='' />
                  <span>
                    Select available caregivers, offer them appointments and set
              ...
              <NavItem>
                <NavLink disabled={selectedCellsCareinstitution ? selectedCellsCareinstitution.length === 0 : true} onClick={() => handleCareGiverBulkEmail('day', false)}>
                  <img src={offer_sent} className='mr-2' alt='' />
                  <span>
                    Select available caregivers, offer them appointments and set
