                    ...
                    (invoiceData: any, index: number) => {
                      ...
                      return (
                        <tr key={count++}>
                          ...
                          <td className="cancellation-col">
                            {" "}
                            {invoiceData.cancelledFor
                              ? invoiceData.cancelledFor
                              : "-"}{" "}
                          </td>
                          <td className="cancel-col">
                            {" "}
                            {invoiceData.cancelledBy
                              ? invoiceData.cancelledBy
                              : "-"}{" "}
                          </td>
                          <td className="careinstitution-col">
                            {invoiceData.careinstitution ? (
                              ...
                              >
                                {[
                                  invoiceData.careinstitution.firstName,
                                  invoiceData.careinstitution.lastName,
                                ].join(" ")}
                              </div>
                            ) : null}
                          </td>
                          ...
                          <td className="vat-col">{invoiceData.PlycocoTax}</td>
