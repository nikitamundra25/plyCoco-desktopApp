...
const QuallificationAttribute: FunctionComponent<FormikProps<IQuallificationAttribute> & any> = (props: FormikProps<IQuallificationAttribute> & any) => {
          ...
          <div className="common-list-body">
            {qualifications && qualifications.length ? (
              <ul className="common-list list-unstyled">
                {qualifications.map((q: IReactSelectInterface, index: number) => {
