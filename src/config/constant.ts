...
export const HealthInsuranceProvider: IReactSelectInterface[] = [
  ...
  { label: languageTranslation('AOK_BADEN'), value: 'AOKBayern' },
  ...
  { label: languageTranslation('BKK_ERNST_YOUNG'), value: 'BKKErnst&amp;Young' },
  ...
  { label: languageTranslation('BKK_G&amp;V'), value: 'BKKG&amp;V' },
  {
  ...
  { label: languageTranslation('BKK_WERRA-Werke'), value: 'BKKWieland-Werke' },
  {
    label: languageTranslation('BKK_Wirtschaft&amp;Finanzen'),
    value: 'BKKWirtschaft&amp;Finanzen',
  },
  {
    label: languageTranslation('BKK_Wirtschaft&amp;Finanzen(NBL)'),
    value: 'BKKWirtschaft&amp;Finanzen(NBL)',
  },
  ...
  { label: languageTranslation('BKK_ZF_&amp;_Partner'), value: 'BKKZF&amp;Partner' },
  { label: languageTranslation('BKK_ZF_&amp;_Partner_(NBL)'), value: 'BKKZF&amp;Partner(NBL)' },
  ...
  { label: languageTranslation('ITSG_Test-AOK NW-eVpT'), value: 'ITSGTest-AOKNW-eVpT' },
