...
const TimesForm: FunctionComponent<FormikProps<IAddTimeFormValues> & any> = (props: FormikProps<IAddTimeFormValues> & any) => {
      ...
      <Table bordered hover responsive>
        <thead className="thead-bg">
          <tr>
            ...
            <th className="text-center">{languageTranslation("TABEL_HEAD_CG_ACTION")}</th>
          </tr>
        </thead>
        <tbody>
                ...
                <tr key={index}>
                  ...
                  <td className="text-center">
                    <span className="cursor-pointer" onClick={() => {
                      const filteredTimes = timesData.filter((t: any, i: number) => i !== index);
