                  ...
                  <Col lg={'7'}>
                    <div className='email-inbox-section'>
                      <div className='email-row-wrap align-items-center email-attributes-wrap'>
                        ...
                        <div className='email-attributes-content d-flex align-items-center'>
                          <i
                            className='fa fa-envelope-open-o mr-1'
                            aria-hidden='true'
                          ></i>

                          <span>{languageTranslation('READ')}</span>
                        </div>
                        <span className='email-attributes-seprator'>|</span>
                        <div className='email-attributes-content d-flex align-items-center'>
                          <i
                            ...
                            aria-hidden='true'
                          ></i>
                          <span>{languageTranslation('UN_READ')}</span>
                        </div>
                        <span className='email-attributes-seprator'>|</span>
                        <div className='email-attributes-content d-flex align-items-center'>
                          <i className='fa fa-tag mr-1' aria-hidden='true'></i>
                          <span>{languageTranslation('MARKED')}</span>
                        </div>
                        <span className='email-attributes-seprator'>|</span>
                        <div className='email-attributes-content'>
                          <i
                            ...
                            aria-hidden='true'
                          ></i>
                          <span>{languageTranslation('CLEAR')}</span>
                        </div>
                      </div>
