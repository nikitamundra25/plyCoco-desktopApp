...
import { Card, CardHeader, CardBody, Col, Row, Button, Badge } from "reactstrap";
                  ...
                  <div className="user-item emloyee-detail-card">
                    ...
                    <div className="profile-text">
                      ...
                      <div className="user-item">
                        {/* <Button>Edit</Button> */}
                        <span className=" text-label">    {employee && employee.firstName ? (
                          <>
                        ...
                        <span className="text-value one-line-text d-flex align-items-center">
                         :&nbsp;&nbsp;<span className="">{employee && employee.firstName
                            ? employee.firstName
                            : "N/A"}
                          &nbsp;&nbsp;
