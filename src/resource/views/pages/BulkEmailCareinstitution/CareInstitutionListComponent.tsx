...
export const CareInstitutionListComponent: FunctionComponent<ICareGiverListComponentProps &
  any> = (props: ICareGiverListComponentProps & any) => {
    ...
    console.log('careInstitutions', careInstitutions);
    ...
    return (
      <Col lg={'5'} className='pr-lg-0'>
        <div id='scrollableDiv' className='caregiver-list custom-scroll'>
          <InfiniteScroll
            dataLength={
              careInstitutions && careInstitutions.careInstitutionData && careInstitutions.careInstitutionData.length ? careInstitutions.careInstitutionData.length : 0
            ...
            hasMore={
              careInstitutions &&
                ...
                ? careInstitutions.totalCount !== careInstitutions.careInstitutionData.length
                  ? true
                  : false
                : false
            }
          ...
          >
            <Table bordered hover responsive className='mb-0'>
              ...
              <tbody>
                ...
                ) : careInstitutions && careInstitutions.careInstitutionData && careInstitutions.careInstitutionData.length > 0 ? (
                  careInstitutions.careInstitutionData.map((item: any, index: number) => {
                    return (
                      <tr
                        key={index}
                        onClick={(e: any) => {
