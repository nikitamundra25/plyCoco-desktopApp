      ...
      <Row className="custom-col">
        <Col sm={4}>
          <Card>
            <div className="offer-wrap">
              ...
              {languageTranslation("OFFER_FOR")} {" "}<span className="font-weight-bold">( {languageTranslation("POSITIVE")})</span>
              </h5>
        ...
        <Col sm={4}>
          <Card>
            <div className="offer-wrap">
              <h5 className="heading toggle-filter">
              {languageTranslation("NO_OFFER_FOR")}{" "}<span className="font-weight-bold">({languageTranslation("NEGATIVE")})</span>
              </h5>
              <div className="offer-content-wrap">
                <ul>
        ...
        <Col sm={4}>
          <Card>
            <div className="offer-wrap">
              <h5 className="heading toggle-filter">
              {languageTranslation("WORKED_AT")} <span className="font-weight-bold">({languageTranslation("POSITIVE")})</span>
              </h5>
              <div className="offer-content-wrap">
                <ul>
